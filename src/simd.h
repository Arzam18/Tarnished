...
#include <cstdint>
    ...
    #include <immintrin.h>
        ...
        inline vepi16 packus_epi16(vepi16 a, vepi16 b){ return _mm512_packus_epi16(a,b); }

        inline vepi32 set1_epi32(int32_t v){ return _mm512_set1_epi32(v); }

        inline vepi32 madd_epi16(vepi16 a, vepi16 b){ return _mm512_madd_epi16(a,b); }

        inline vepi32 add_epi32(vepi32 a, vepi32 b){ return _mm512_add_epi32(a,b); }

        inline int reduce_epi32(vepi32 v){ return _mm512_reduce_add_epi32(v); }
        ...
        inline vps32 mul_add_ps(vps32 a,vps32 b,vps32 c){ return _mm512_fmadd_ps(a,b,c); }
        ...
        inline vepi16 packus_epi16(vepi16 a, vepi16 b){ return _mm256_packus_epi16(a,b); }

        inline vepi32 set1_epi32(int32_t v){ return _mm256_set1_epi32(v); }

        inline vepi32 madd_epi16(vepi16 a, vepi16 b){ return _mm256_madd_epi16(a,b); }

        inline vepi32 add_epi32(vepi32 a, vepi32 b){ return _mm256_add_epi32(a,b); }
    ...
    inline vepi32 dpbusdx2_epi32(const vepi32 sum, const vepi8 vec0, const vepi8 vec1, const vepi8 vec2, const vepi8 vec3) {
        vepi32 intermediate = dpbusd_epi32(sum, vec0, vec1);
        return dpbusd_epi32(intermediate, vec2, vec3);
    }
